...
|---|---|---|
| pH | 9 | 9 |
| Ammonia | 2 ppm | 0.25 ppm |
| Nitrite | 2 ppm | 0 ppm |
| Phosphate | 5 ppm | 1 ppm |

Genuinely encouraging, despite the green water. Ammonia has dropped from 2 ppm back down to 0.25, and nitrite has gone from 2 ppm to zero. That's the nitrogen cycle catching up: the bacteria that convert nitrite to nitrate have established, so the spike from the die-off is clearing. Phosphate is the headline though, down from 5 ppm to 1, the lowest it's been since I started. The clear-out and the plants are pulling it out of the water faster than it's going in. So the paradox of the day is that the pond looks its worst and reads its best.
