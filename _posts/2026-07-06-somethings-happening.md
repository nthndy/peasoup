...
![Test kit vials against the colour chart]({{ site.baseurl }}/assets/img/testing_3.jpg)
...
I also added a little water ramp made from some old sun-bleached bits of wood I found on a beach years ago, so that any bugs and critters that fall in have a way to climb back out. Not much has changed from day one to look at, but this is a patient game we're playing here. Wait and see.
